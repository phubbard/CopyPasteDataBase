...
| Semantic search (embeddings + hybrid RRF rank) | ✅ 3.3.0 (NLContextualEmbedding 512-dim, macOS 14+) | ✅ 3.3.0 (query-side; vectors sync via CloudKit) | ⏳ | Per-platform models by design (model_id/revision cols): Windows = ONNX MiniLM/DirectML. [`docs/handoffs/windows-v33-features.md`](handoffs/windows-v33-features.md) |
