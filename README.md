...
| 2.8+ | Notarisation, App Store submission for the iOS companion, garbage collection of pre-v2.1 wire-format orphans on the CloudKit zone, size-budget eviction | ⏳ |
