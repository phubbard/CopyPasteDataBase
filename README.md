...
| **Relay sync substrate** | Cross-platform replacement for CloudKit. Cloudflare Worker + Durable Object + R2, end-to-end encrypted via 32-byte PSK shared as 8-word Diceware passphrase. Phase A: protocol spec ([`docs/relay-protocol.md`](docs/relay-protocol.md)) + Worker scaffold ([`cpdb-relay/`](cpdb-relay/)) — clients still TODO | ⏳ |
